 ...
 * Rendering happens here (not baked into the HTML) specifically to keep the data
 * and the markup decoupled. Parsing is delegated to PapaParse (vendored at
 * js/papaparse.min.js) rather than hand-rolled, so edge cases like quoted
 * fields, embedded commas/newlines, and escaped quotes are handled correctly.
 */
